...
let s:p.visual.middle = [ [ 'brightorange', 'NONE', 'NONE' ] ]
let s:p.normal.middle = [ [ 'brightgreen', 'NONE', 'NONE' ] ]
let s:p.insert.middle = [ [ 'darkestcyan', 'NONE', 'NONE' ] ]
let s:p.inactive.middle = [ [ 'gray5', 'NONE', 'NONE' ] ]
let s:p.replace.middle = [ [ 'brightred', 'NONE', 'NONE' ] ]
let s:p.replace.right = s:p.normal.right
let s:p.tabline.left = [ [ 'white', 'gray4' ] ]
let s:p.tabline.tabsel = [ [ 'darkestgreen', 'brightgreen' ] ]
let s:p.tabline.middle = [ [ 'gray4', 'NONE', 'NONE' ] ]
let s:p.tabline.right = [ [ 'white', 'gray4' ] ]
let s:p.normal.error = [ [ 'gray9', 'brightestred' ] ]
let s:p.normal.warning = [ [ 'gray1', 'yellow' ] ]

let g:lightline#colorscheme#lightline_transparent#palette = lightline#colorscheme#fill(s:p)
